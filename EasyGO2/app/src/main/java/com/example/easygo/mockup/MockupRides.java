...
public class MockupRides {
    ...
    public static HashMap<Integer, Ride> getRides() {
        ...
        Ride ride1 = new Ride(1, start1, end1, 20, 30, false, false, false, false, status, null, driver1, null, null, null);
        Ride ride2 = new Ride(2, start2, end2, 10, 30, false, false, false, false, status, null, driver2, null, null, null);
        Ride ride3 = new Ride(3, start3, end3, 30, 30, false, false, false, false, status, null, driver3, null, null, null);
